...
/**
 * Decodes a Docker stream buffer and returns the accumulated stdout and stderr output as strings.
 * @param buffer - The buffer containing the Docker stream data.
 * @returns An object containing the accumulated stdout and stderr output.
 */
