...
function Description({ descriptionText }: { descriptionText: string }) {
	...
	return (
		...
		>
			<div
				className="h-full overflow-auto leftPanel"
				style={{ width: `${leftWidth}%` }}
			>
				<div
					role="tablist"
					className="w-3/5 tabs tabs-boxed"
				>
					<a
			...
			<div
				className="flex flex-col h-full overflow-auto rightPanel"
			...
			>
				<div className="flex gap-x-1.5 justify-start items-center px-4 py-2 basis-[5%]">
					...
					<div>
						<select
							className="w-full max-w-xs select select-info select-sm"
							value={language}
				...
				<div className="flex flex-col editor-console grow-[1] ">
					...
					<div className="rounded-none collapse bg-base-200">
						...
						<div className="collapse-content bg-primary text-primary-content peer-checked:bg-secondary peer-checked:text-secondary-content">
							<div
								role="tablist"
								className="w-3/5 mb-4 tabs tabs-boxed"
							>
								<a
							...
							{testCaseTab === "input" ? (
								<textarea
									rows={4}
									cols={70}
									className="text-white rounded-md resize-none bg-neutral"
								/>
							) : (
